 ...
 *
 * Structurally identical to {@link RadioGroupOption} today, but kept
 * separate so future divergence in either component's option layout
 * doesn't have to ripple across both.
 */
