 ...
 *
 * Adds a role to a {@link Member | guild member}. Requires the `MANAGE_ROLES` permission. Returns a 204 empty response on success. Fires a Guild Member Update Gateway event.
 *
 * > [!NOTE]
 * >
