...
export const messageSchema = v.object({
  ...
  editedTimestamp: v.nullable<v.GenericSchema<string>>(
  ...
  mentionRoles: v.array(snowflake as v.GenericSchema<string>),
  ...
  webhookId: v.exactOptional<v.GenericSchema<string>>(snowflake),
  /** type of message */
