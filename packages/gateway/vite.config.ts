...
export default defineConfig({
  ...
  pack: {
    ...
    // src file maps 1:1 to a dist file so subpath exports resolve and
    // consumers tree-shake at the file boundary. That boundary is the whole
    // point here — importing `onMessageCreate` must not pull in every other
