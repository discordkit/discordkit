...
const bindings = defineBindings({
  ...
  getMessage: /* C */ `bool Discord_Client_GetMessageHandle(void *self, uint64_t messageId, void *returnValue)`,
  getChannel: /* C */ `bool Discord_Client_GetChannelHandle(void *self, uint64_t channelId, void *returnValue)`,
