...
const bindings = defineBindings({
  ...
  participants: /* C */ `void Discord_Call_GetParticipants(void *self, Discord_Span *returnValue)`,
  voiceState: /* C */ `bool Discord_Call_GetVoiceStateHandle(void *self, uint64_t userId, void *returnValue)`,
  ...
  vadThreshold: /* C */ `void Discord_Call_GetVADThreshold(void *self, void *returnValue)`,
