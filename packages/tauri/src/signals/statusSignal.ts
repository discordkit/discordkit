 ...
 * framework-agnostic reactive state for the webview. The bridge's status is
 * delivered over kkrpc events (push) but a signal needs a synchronous current
 ...
 * @example
 * ```ts
 * import { statusSignal } from "@discordkit/tauri/signals";
