...
import { videoQualityModeSchema } from "./VideoQualityMode";
...
export const channelSchema = z.object({
  ...
  permissionOverwrites: overwriteSchema.array().optional(),
  ...
  recipients: userSchema.array().optional(),
  ...
  threadMetadata: threadSchema.optional(),
