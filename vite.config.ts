...
export default defineConfig({
  run: {
    tasks: {
      ...
      // a full package rebuild.
      "clean:test": {
        command: `rimraf --glob "examples/*/test-results" "examples/*/playwright-report" "examples/*/blob-report" ".playwright-mcp" "coverage"`,
        cache: false
      },
      // Example build output + generated codegen (regenerated by each example's
      // build/typegen). Leaves package dist intact.
      "clean:examples": {
        command: `rimraf --glob "examples/*/dist" "examples/*/.next" "examples/*/.astro" "examples/*/.output" "examples/*/env.d.ts"`,
        cache: false
      },
